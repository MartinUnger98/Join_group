    ...
    <div class="ctcEditorRightFirst">
        <div class="placeholderContact">
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask0_71395_17941" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                    width="64" height="64">
...
function detailView(i) {
    ...
    <div class="detailViewHead">
                    <div class="initalsDetailView"><span id="initalsDetail">${getInitials(allContacts[i]['name'])}</span></div>
                    <div>
                        <h2 id="headDetail" class="headDetailView">${allContacts[i]['name']}</h2>
                        <div class="detailViewButton">
                            <div class="buttonSpace">
                            <button class="detailButton" id="editButtonDetail" onclick="editContact(${i})"><svg class="svgBtnDetailView" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 17H3.4L12.025 8.375L10.625 6.975L2 15.6V17ZM16.3 6.925L12.05 2.725L13.45 1.325C13.8333 0.941667 14.3042 0.75 14.8625 0.75C15.4208 0.75 15.8917 0.941667 16.275 1.325L17.675 2.725C18.0583 3.10833 18.2583 3.57083 18.275 4.1125C18.2917 4.65417 18.1083 5.11667 17.725 5.5L16.3 6.925ZM14.85 8.4L4.25 19H0V14.75L10.6 4.15L14.85 8.4Z" fill="#2A3647"/>
                                </svg><span>Edit</span>
                                </button>
                            </div>
                            <div class="buttonSpace">
                            <button class="detailButton" id="deleteButtonDetail" onclick="deleteContact(${i})"><svg class="svgBtnDetailView" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="addContactRight">
    <div class="ctcEditorRightFirst">
        <div id="initialDiv" class="placeholderContact">
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask0_71395_17941" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                    width="64" height="64">
                    <rect width="64" height="64" fill="#D9D9D9" />
